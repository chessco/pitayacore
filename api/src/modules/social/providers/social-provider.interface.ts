export interface SocialProvider {
  authenticate(tenantId: string): Promise<{ success: boolean; url?: string; token?: string }>;
  publish(
    tenantId: string,
    content: string,
    mediaUrls: string[],
  ...
  delete(tenantId: string, externalId: string): Promise<{ success: boolean; error?: string }>;
