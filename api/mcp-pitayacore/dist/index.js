...
const DEFAULT_TENANT_ID = process.env.DEFAULT_TENANT_ID || '2bf7a176-a1e5-4310-9793-fbaf27bb2606';
if (!API_KEY) {
...
const server = new Server({ name: 'pitayacore-mcp', version: '1.0.0' }, { capabilities: { resources: {}, tools: {} } });
